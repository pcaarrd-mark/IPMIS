            ...
            <div class="card-body">
              <div class="tab-content" id="custom-tabs-two-tabContent">
                ...
                <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel" aria-labelledby="custom-tabs-two-profile-tab">
                   <div class="row">
                      <div class="col-12">
                        <label for="exampleInputEmail1">12.1. PAP ATTRIBUTION BY EXPENSE CLASS</label>
                        {{-- &nbsp;&nbsp;<a href="javascript:void(0);" class="btn-primary btn-sm" onclick="addnewrow('tbl_pap')"><i class="fas fa-plus"></i> --}}
                        </a>
                                <table class="table table-bordered" id="tbl_pap">
                                  ...
                                  <tr>
                                    <td class="align-middle" align="center">
                                      <b>PS</b>
                                      <input type="hidden" class="form-control budget" id="pap_ps" name="project_pap[]" value="1">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget yr1" name="project_pap_yr1[]">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget" name="project_pap_yr2[]">
                                    </td><td class="align-middle" align="center budget">
                                      <input type="number" class="form-control budget" name="project_pap_yr3[]">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td class="align-middle" align="center">
                                      <b>MOOE</b>
                                      <input type="hidden" class="form-control budget" id="pap_ps" name="project_pap[]" value="2">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget yr1" name="project_pap_yr1[]">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget" name="project_pap_yr2[]">
                                    </td><td class="align-middle" align="center">
                                      <input type="number" class="form-control budget" name="project_pap_yr3[]">
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td class="align-middle" align="center">
                                      <b>CO/EO</b>
                                      <input type="hidden" class="form-control budget" id="pap_ps" name="project_pap[]" value="3">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget yr1" name="project_pap_yr1[]">
                                    </td>
                                  ...
                                  <tr>
                                    <td class="align-middle" align="center">
                                      <b>FinEx</b>
                                      <input type="hidden" class="form-control budget" id="pap_ps" name="project_pap[]" value="4">
                                    </td>
                                    <td class="align-middle" align="center">
                                      <input type="number" class="form-control budget yr1" name="project_pap_yr1[]">
                                    </td>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <label for="exampleInputEmail1">12.4. REQUIREMENTS FOR OPERATING COST OF INFRASTRUCTURE PROJECT</label>
                        {{-- &nbsp;&nbsp;<a href="javascript:void(0);" class="btn-primary btn-sm" onclick="addnewrow('tbl_infra')"><i class="fas fa-plus"></i> --}}
                        </a>
                        <table class="table table-bordered" id="tbl_infra">
                          ...
                          <tr>
                            <td class="align-middle" align="center">
                              <b>PS</b>
                              <input type="hidden" class="form-control" id="pap_ps" name="project_infra[]" value="1">
                            </td>
                            <td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr1[]">
                            </td>
                            <td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr2[]">
                            </td><td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr3[]">
                            </td>
                          </tr>
                          <tr>
                            <td class="align-middle" align="center">
                              <b>MOOE</b>
                              <input type="hidden" class="form-control" id="pap_ps" name="project_infra[]" value="2">
                            </td>
                            <td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr1[]">
                            </td>
                          ...
                          <tr>
                            <td class="align-middle" align="center">
                              <b>CO/EO</b>
                              <input type="hidden" class="form-control" id="pap_ps" name="project_infra[]" value="3">
                            </td>
                            <td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr1[]">
                            </td>
                          ...
                          <tr>
                            <td class="align-middle" align="center">
                              <b>FinEx</b>
                              <input type="hidden" class="form-control" id="pap_ps" name="project_infra[]" value="4">
                            </td>
                            <td class="align-middle" align="center">
                              <input type="number" class="form-control" name="project_infra_yr1[]">
                            </td>
