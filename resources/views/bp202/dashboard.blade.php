                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-striped table-valign-middle">
                    ...
                    <tr>
                        ...
                        <th colspan = "4" style="border: 1px solid #DDD"><center>2027</center></th>
                    </tr>
                    <tr>
                    ...
                    @foreach (getDivision() as $item)
                      <?php
                        ...
                        $rd_y2 = getDivisionProposalType('RD',$item->division_id,(date('Y')+2));
                        $nonrd_y2 = getDivisionProposalType('NONRD',$item->division_id,(date('Y')+2));
                        // $totalproposal_y2 = getDivisionProposal($item->division_id,(date('Y')+2));
                        $totalproposal_y2 = $rd_y2 + $nonrd_y2;
                        ...
                        $rd_y3 = getDivisionProposalType('RD',$item->division_id,(date('Y')+3));
                        $nonrd_y3 = getDivisionProposalType('NONRD',$item->division_id,(date('Y')+3));
                        // $totalproposal_y3 = getDivisionProposal($item->division_id,(date('Y')+3));
                        $totalproposal_y3 =  $rd_y3 + $nonrd_y3;
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="right">
                            <a href="{{ url('/overview/RD/'.$item->division_id.'/2026') }}" target="_blank">{{ formatNum($rd_y2) }}</a>
                          </td>
                          <td align="right">
                            <a href="{{ url('/overview/NONRD/'.$item->division_id.'/2026') }}" target="_blank">{{ formatNum($nonrd_y2) }}</a>
                          </td>
                          <td align="right">
                            <a href="{{ url('/overview/ALL/'.$item->division_id.'/2026') }}" target="_blank">{{ formatNum($totalproposal_y2) }}</a>
                          </td>
                          <td align="right">
                            {{ formatNum(number_format(getDivisionProposalBudget($item->division_id,(2026)))) }}
                          </td>
                          <td align="right">
                            <a href="{{ url('/overview/RD/'.$item->division_id.'/2027') }}" target="_blank">{{ formatNum($rd_y3) }}</a>
                          </td>
                          <td align="right">
                            <a href="{{ url('/overview/NONRD/'.$item->division_id.'/2027') }}" target="_blank">{{ formatNum($nonrd_y3) }}</a>
                          </td>
                          <td align="right">
                            <a href="{{ url('/overview/ALL/'.$item->division_id.'/2027') }}" target="_blank">{{ formatNum($totalproposal_y3) }}</a>
                          </td>
                          <td align="right">
                    ...
                    <tr style="font-size: 20px">
                      ...
                      <td style="border: 1px solid #DDD" align="right"><b><a href="{{ url('/overview/ALL/ALL/2024') }}" target="_blank">{{ number_format(getTotalProjCost((date('Y')+1))) }}</a></b></td>
