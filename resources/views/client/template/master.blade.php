...
<head>
    ...
    <title>Menu big logo | Components | Yellow Business</title>
    <meta name="description" content="Menu big logo component, Bootstrap menu with top logo.">
    <script src="{{ asset('client/Template/HTWF/scripts/jquery.min.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/scripts/bootstrap/css/bootstrap.css') }}">
    <script src="{{ asset('client/Template/HTWF/scripts/script.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/style.css') }}">
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/scripts/flexslider/flexslider.css') }}">
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/css/content-box.css') }}">
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/css/animations.css') }}">
    <link rel="stylesheet" href="{{ asset('client/Template/HTWF/css/components.css') }}">
    <link rel="icon" href="{{ asset('client/Template/images/favicon.png') }}">
    <link rel="stylesheet" href="{{ asset('client/Template/skin.css') }}">
</head>
<body>
            ...
            <div class="navbar navbar-main  mega-menu-fullwidth">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img src="{{ asset('client/Template/images/logo-badge-pmpc.png') }}" alt="logo" width="143" height="181"/> </a>
                    </div>
        ...
        <div class="content">
            ...
            <div class="row copy-row">
                <div class="col-md-12 copy-text">
                    © 2018 Yellow Business - Multipurpose & Modern Html Template Handmade by <a href="http://schiocco.io/">schiocco.io</a>
                </div>
            </div>
        </div>
        <link rel="stylesheet" href="{{ asset('client/Template/HTWF/scripts/font-awesome/css/font-awesome.min.css') }}">
        <script src="{{ asset('client/Template/HTWF/scripts/bootstrap/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('client/Template/HTWF/scripts/flexslider/jquery.flexslider-min.js') }}"></script>
        <script src="{{ asset('client/Template/HTWF/scripts/jquery.tab-accordion.js') }}"></script>
        <script src="{{ asset('client/Template/HTWF/scripts/parallax.min.js') }}"></script>
    </footer>
</body>
</html>
