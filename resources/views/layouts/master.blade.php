...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('admintemplate/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('admintemplate/dist/img/pcaarrd-logo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('admintemplate/dist/img/pcaarrd-logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">IPMIS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      @elseif(Auth::user()->usertype == 'Proponent')
        @include('layouts.proponent-sidebar')
      @elseif(Auth::user()->usertype == 'ISP Manager')
        @include('layouts.ispmanager-sidebar')
      @endif
  ...
  <div class="content-wrapper">
    ...
    <form method="POST" id="frm_project_update" enctype="multipart/form-data" role="form">
      @csrf
      <input type="hidden" name="update_project_id" id="update_project_id" value="">
      <input type="hidden" name="update_project_status" id="update_project_status" value="">
  </form>

  </div>
  <!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="#">IPMIS | Integrated Project Management System</a>.</strong>
    All rights reserved.
...
<script>
  ...
  function regionSelect(prov,mun,bgry,id)
  {
    $("#"+prov+",#"+mun+",#"+bgry).empty();
    loadJSON(prov,"locprovince","{{ url('/library/locprovince') }}/"+id);
  }

  function provinceSelect(slct,id)
  {
    $("#"+slct).empty();
    loadJSON(slct,"locmunicipal","{{ url('/library/locmunicipal') }}/"+id);
  }

  function municipalSelect(slct,id)
  {
    $("#"+slct).empty();
    loadJSON(slct,"locbarangay","{{ url('/library/locbarangay') }}/"+id);
  }
