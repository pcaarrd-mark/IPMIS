  ...
  <body class="p-2">
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            <thead>
                <tr class="bg-info">
                    <th><center>PROJECT YEAR</<center></th>
                    <th style="width: 20%"><center>PS</<center></th>
                    <th style="width: 20%"><center>MOOE</center></th>
                    <th style="width: 20%"><center>EO/CO</center></th>
                <tr>
            </thead>
            @for($x = 1;$x <= $data['yrs'];$x++)
                <tr>
                    <td align="center">{{$x}}</td>
                    <td align="right"><span id="yr-{{$x}}-ps-total"></span></td>
                    <td align="right"><span id="yr-{{$x}}-mooe-total"></span></td>
                    <td align="right"><span id="yr-{{$x}}-eo-total"></span></td>
                </tr>
            @endfor
        </table>
          ...
          @for($x = 1;$x <= $data['yrs'];$x++)
            ...
            <div class="tab-pane fade {{$active}}" id="ex3-tabs-{{$x}}" role="tabpanel" aria-labelledby="ex3-tab-{{$x}}">
                ...
                <table class="table table-bordered" border="1" cellpadding="0" cellspacing="0">
                    ...
                    @endforeach
                    <tr class="fw-bold" id="yr-{{$x}}-ps-ic" style="display: none">
                    ...
                    @endforeach
                    <tr class="fw-bold" id="yr-{{$x}}-mooe-ic" style="display: none">
                    ...
                    <tr class="fw-bold" id="yr-{{$x}}-eo-dc">
                        <td>Direct Cost <button type="button" class="btn btn-info btn-sm float-end" onclick="addRow('yr-{{$x}}-eo-dc',{{$totalmons}},3)"><i class="fas fa-plus fa-xs"></i></button></td>
                        <td colspan="{{$totalmons}}"></td>
                    </tr>
                    ...
                    @endforeach
                    <tr class="fw-bold" id="yr-{{$x}}-eo-ic" style="display: none">
